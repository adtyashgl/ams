    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                authTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, (Void[]) null);
            }else {*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                } else if (loginResponse.code() == UNAUTHORIZED) {
                    mFailureReason = "Invalid Username/Password.";
                    loginResponse.body().close();
                    return false;

                } else {
                    mFailureReason = "Invalid Request. Please try after sometime";
                    loginResponse.body().close();
                    return false;
                }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Cache.setInCache(context,Constants.CACHE_PREFIX_IS_LOGGED_IN,true,Constants.TYPE_BOOL);
                Intent intent = new Intent(LoginActivity.this, FranchiseSelectionActivity.class);
                startActivity(intent);
                finish();

            } else {
                passwordView.setError(mFailureReason);
        ...
        private Request buildLoginRequest() throws JSONException {
